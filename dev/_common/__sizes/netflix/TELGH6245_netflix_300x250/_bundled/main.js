...
var _commonJsMove_bbJs = require('../../_common/js/move_bb.js');

var _commonJsMove_bbJs2 = _interopRequireDefault(_commonJsMove_bbJs);

(0, _commonJsMove_bbJs2['default'])('netflix', 'bb');

module.exports = {};

},{"../../_common/js/move_bb.js":3}],2:[function(require,module,exports){
'use strict';
...
function start(type, size) {
	...
	tl.to('.animalHolder', .3, { opacity: 0, ease: Power2.easeInOut }, '+=.6');
