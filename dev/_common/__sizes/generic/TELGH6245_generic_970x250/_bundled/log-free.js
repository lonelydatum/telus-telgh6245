...
(0, _commonJsMove_970Js2['default'])('generic', '970');
...
function start(type, size) {
	...
	tl.from('.animalHolder', .4, { scale: 1, y: 270 });
	tl.to('.animalHolder', .3, { scale: 1.1, yoyo: true, left: 40, top: -5, repeat: 1, ease: Sine.easeIn }, '-=.2');
