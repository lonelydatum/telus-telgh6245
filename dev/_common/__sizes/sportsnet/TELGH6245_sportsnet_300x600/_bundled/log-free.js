...
var _commonJsMove_dbbJs = require('../../_common/js/move_dbb.js');

var _commonJsMove_dbbJs2 = _interopRequireDefault(_commonJsMove_dbbJs);

(0, _commonJsMove_dbbJs2['default'])('sportsnet', 'dbb').gotoAndPlay("f2_in");

module.exports = {};

},{"../../_common/js/move_dbb.js":3}],2:[function(require,module,exports){
'use strict';
...
function start(type, size) {
	...
	tl.to('.monkey_hop_shadow', .4, { opacity: 0, x: startX + hop.x * 4 + 90, ease: Sine.easeOut }, "hop_2");
