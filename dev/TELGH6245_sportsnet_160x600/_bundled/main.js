...
var _commonJsMove_ssJs = require('../../_common/js/move_ss.js');

var _commonJsMove_ssJs2 = _interopRequireDefault(_commonJsMove_ssJs);

(0, _commonJsMove_ssJs2['default'])('sportsnet', 'ss').gotoAndPlay("f2_in");

module.exports = {};

},{"../../_common/js/move_ss.js":3}],2:[function(require,module,exports){
'use strict';
...
function start(type, size) {
	...
	var bez2 = [{ x: startX + hop.x * 3, y: startY - hop.y }, { x: startX + hop.x * 4 + 90, y: startY }];
	...
	tl.add("hop_2", "+=.5");
	tl.to('.monkey_hop', .6, { bezier: { curviness: curviness, values: bez2 }, ease: Sine.easeOut }, "hop_2");
	...
	tl.from('.monkey_popping_out', .4, { y: "+=45", ease: Power3.easeOut, onComplete: _commonJs.screen_rotate }, '+=1');
