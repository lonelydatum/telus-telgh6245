...
var _commonJsMove_970Js = require('../../_common/js/move_970.js');

var _commonJsMove_970Js2 = _interopRequireDefault(_commonJsMove_970Js);

(0, _commonJsMove_970Js2['default'])('sportsnet', '970').gotoAndPlay("f2_in");

module.exports = {};

},{"../../_common/js/move_970.js":3}],2:[function(require,module,exports){
'use strict';
...
function start(type, size) {
	...
	////////////////////////////
	// tl.add('f2_in')
	tl.set('.frame2', { opacity: 1 }, 0);
	tl.from('.t1', .8, { opacity: 0, ease: Sine.easeOut }, .1);
	tl.from('.animalHolder', .4, { scale: 1, y: 270 }, 0);
	tl.to('.animalHolder', .3, { scale: 1.1, yoyo: true, left: 40, top: -5, repeat: 1, ease: Sine.easeIn }, 0);
